...
public class ProductApplyReqDTO extends BaseDTO {
     ...
     * 产品详细
     */
    private List<ProductDetailApply> detailApplyList;
    ...
    /**
     * 获取 状态:0：未审核；1、申请上架中；2、上架；3、拒绝上架；4、下架；5、授让；6：已审核但没上架； t_product_apply.product_status
     *
     * @return 状态:0：未审核；1、申请上架中；2、上架；3、拒绝上架；4、下架；5、授让；6：已审核但没上架；
     */
    ...
    /**
     * 设置 状态:0：未审核；1、申请上架中；2、上架；3、拒绝上架；4、下架；5、授让；6：已审核但没上架； t_product_apply.product_status
     *
     * @param productStatus 状态:0：未审核；1、申请上架中；2、上架；3、拒绝上架；4、下架；5、授让；6：已审核但没上架；
     */
     ...
     * @return
     */
    public List<ProductDetailApply> getDetailApplyList() {
        return detailApplyList;
    }

    public void setDetailApplyList(List<ProductDetailApply> detailApplyList) {
        this.detailApplyList = detailApplyList;
    }
}

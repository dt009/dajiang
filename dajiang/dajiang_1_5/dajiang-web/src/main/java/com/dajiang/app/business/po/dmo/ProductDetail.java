...
public class ProductDetail extends BaseDTO {
    ...
    /**
     * 获取 t_product_detail.product_detail_id
     *
     * @return t_product_detail.product_detail_id
     */
    ...
    /**
     * 设置 t_product_detail.product_detail_id
     *
     * @param productDetailId t_product_detail.product_detail_id
     */
    ...
    /**
     * 获取 标题 t_product_detail.product_detail_title
     *
     * @return 标题
     */
    ...
    /**
     * 设置 标题 t_product_detail.product_detail_title
     *
    ...
    /**
     * 获取 t_product_detail.product_id
     *
     * @return t_product_detail.product_id
     */
    ...
    /**
     * 设置 t_product_detail.product_id
     *
     * @param productId t_product_detail.product_id
     */
    ...
    /**
     * 获取 产品明细种类：1、视频；2、音频；3、文件；4、文字说明；5、图片；6：封面 t_product_detail.product_detail_type
     *
    ...
    /**
     * 设置 产品明细种类：1、视频；2、音频；3、文件；4、文字说明；5、图片；6：封面 t_product_detail.product_detail_type
     *
    ...
    /**
     * 获取 产品详细指向路径 t_product_detail.product_path
     *
     * @return 产品详细指向路径
     */
    ...
    /**
     * 设置 产品详细指向路径 t_product_detail.product_path
     *
    ...
    /**
     * 获取 产品链接 t_product_detail.product_detail_url
     *
     * @return 产品链接
     */
    ...
    /**
     * 设置 产品链接 t_product_detail.product_detail_url
     *
    ...
    /**
     * 获取 产品描述 t_product_detail.product_detail_desc
     *
     * @return 产品描述
     */
    ...
    /**
     * 设置 产品描述 t_product_detail.product_detail_desc
     *
    ...
    /**
     * 获取 显示顺序 t_product_detail.product_detail_sort
     *
     * @return 显示顺序
     */
    ...
    /**
     * 设置 显示顺序 t_product_detail.product_detail_sort
     *

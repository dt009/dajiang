 ...
 */
public class ProfessionalRespDTO extends BaseDTO {
     ...
     * 大匠专业描述
     */
    private String professionalTypeStr;
     ...
     * 职业资格证书路径
     */
    private List<ProfessionalPhoto> qualificationPicList;

    /**
     * 获奖证书
     */
    private List<ProfessionalPhoto> certificatePicList;

    /**
     * 其他图片
     */
    private List<ProfessionalPhoto> otherPicList;
    ...
    public String getProfessionalTypeStr() {
        return professionalTypeStr;
    }

    public void setProfessionalTypeStr(String professionalTypeStr) {
        this.professionalTypeStr = professionalTypeStr;
    }
    ...
    public List<ProfessionalPhoto> getQualificationPicList() {
        return qualificationPicList;
    }

    public void setQualificationPicList(List<ProfessionalPhoto> qualificationPicList) {
        this.qualificationPicList = qualificationPicList;
    }

    public List<ProfessionalPhoto> getCertificatePicList() {
        return certificatePicList;
    }

    public void setCertificatePicList(List<ProfessionalPhoto> certificatePicList) {
        this.certificatePicList = certificatePicList;
    }

    public List<ProfessionalPhoto> getOtherPicList() {
        return otherPicList;
    }

    public void setOtherPicList(List<ProfessionalPhoto> otherPicList) {

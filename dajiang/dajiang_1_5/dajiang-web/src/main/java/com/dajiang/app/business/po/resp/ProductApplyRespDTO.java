...
public class ProductApplyRespDTO extends BaseDTO {
    ...
    private List<ProductDetailApply> detailList;

    /**
     * 获取 t_product.product_id
     *
     * @return t_product.product_id
     */
    ...
    /**
     * 设置 t_product.product_id
     *
     * @param productId t_product.product_id
     */
    ...
    /**
     * 获取 标题说明 t_product.product_title
     *
     * @return 标题说明
     */
    ...
    /**
     * 设置 标题说明 t_product.product_title
     *
    ...
    /**
     * 获取 产品类型：1、共享知识；2、授权知识 t_product.product_type
     *
    ...
    /**
     * 设置 产品类型：1、共享知识；2、授权知识 t_product.product_type
     *
    ...
    /**
     * 获取 产品专业分类id t_product.professional_type_id
     *
     * @return 产品专业分类id
     */
    ...
    /**
     * 设置 产品专业分类id t_product.professional_type_id
     *
    ...
    /**
     * 获取 状态:1、商品保存，未提交审核；2，提交审核但不提交上架，3、提交审核并提交上架，4，拒绝通过，5、审核通过，6、商品上架；7、商品下架； t_product.product_status
     *
    ...
    /**
     * 设置 状态:1、商品保存，未提交审核；2，提交审核但不提交上架，3、提交审核并提交上架，4，拒绝通过，5、审核通过，6、商品上架；7、商品下架； t_product.product_status
     *
    ...
    /**
     * 获取 原创,即上架大匠id
     * 如果为空，显示名称 t_product.user_id_author
     *
     * @return 原创, 即上架大匠id
     * 如果为空，显示名称
     */
    ...
    /**
     * 获取 原创人姓名 t_product.product_author_name
     *
     * @return 原创人姓名
     */
    ...
    /**
     * 设置 原创人姓名 t_product.product_author_name
     *
    ...
    /**
     * 获取 产品说明 t_product.product_desc
     *
     * @return 产品说明
     */
    ...
    /**
     * 设置 产品说明 t_product.product_desc
     *
    ...
    /**
     * 获取 专利号 t_product.product_patent_number
     *
     * @return 专利号
     */
    ...
    /**
     * 设置 专利号 t_product.product_patent_number
     *
    ...
    /**
     * 获取 专利类型：1：发明专利；2：实用新型；3：设计方案； t_product.product_patent_type
     *
    ...
    /**
     * 设置 专利类型：1：发明专利；2：实用新型；3：设计方案； t_product.product_patent_type
     *
    ...
    /**
     * 获取 创建时间 t_product.product_createDT
     *
     * @return 创建时间
     */
    ...
    /**
     * 设置 创建时间 t_product.product_createDT
     *
    ...
    /**
     * 获取 修改时间 t_product.product_updateDT
     *
     * @return 修改时间
     */
    ...
    /**
     * 设置 修改时间 t_product.product_updateDT
     *
    ...
    /**
     * 获取 产品类别：1、专利技术；2、图文知识；3、视频知识 t_product.product_style
     *
    ...
    /**
     * 设置 产品类别：1、专利技术；2、图文知识；3、视频知识 t_product.product_style
     *
    ...
    public List<ProductDetailApply> getDetailList() {
        return detailList;
    }

    public void setDetailList(List<ProductDetailApply> detailList) {
